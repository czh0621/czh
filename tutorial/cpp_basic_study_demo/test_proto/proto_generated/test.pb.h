...
// double price = 4;
inline void Person::clear_price() {
  price_ = 0;
}
inline double Person::_internal_price() const {
  return price_;
}
inline double Person::price() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.price)
  return _internal_price();
}
inline void Person::_internal_set_price(double value) {
  
  price_ = value;
}
inline void Person::set_price(double value) {
  _internal_set_price(value);
  // @@protoc_insertion_point(field_set:tutorial.Person.price)
}
...
inline const std::string& Person::info() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.info)
  return _internal_info();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Person::set_info(ArgT0&& arg0, ArgT... args) {
 ...
 info_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tutorial.Person.info)
}
inline std::string* Person::mutable_info() {
  std::string* _s = _internal_mutable_info();
  // @@protoc_insertion_point(field_mutable:tutorial.Person.info)
  return _s;
}
inline const std::string& Person::_internal_info() const {
  return info_.Get();
}
inline void Person::_internal_set_info(const std::string& value) {
  
  info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Person::_internal_mutable_info() {
  
  return info_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Person::release_info() {
  // @@protoc_insertion_point(field_release:tutorial.Person.info)
  return info_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Person::set_allocated_info(std::string* info) {
  if (info != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:tutorial.Person.info)
}
